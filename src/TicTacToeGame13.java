/*
 * This java program give option to play again or stop the game
 */
package tictactoe;
...
public class TicTacToeGame13 {
	...
	public static void main(String[] args) {
		...
		do {
			/*
			 * As UC13 mentioned if player want to play new game then should press 1
			 * or want to exit press 0.
			 */
