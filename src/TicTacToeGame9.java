/*
 * This java program allow user to check the board and play to block computer's win
 * 
 */
package tictactoe;
...
public class TicTacToeGame9 {
	...
	public static void main(String[] args) {
		...
		TicTacToeGame8 game = new TicTacToeGame8();
		...
		game.gameStatus();
		/*
		 * Here we are solving UC8 by giving chance to computer to ask for a 
		 * for position he wanted it will play like a human
		 */
		game.makeMoveComputer(sc);
